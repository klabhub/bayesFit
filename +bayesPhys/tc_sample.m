...
switch lower(tc_func_name)
    ...
    case 'sigmoid'
        ...
        setup_prior(sdk, 1,'normal',5,10,10,opts);
        setup_prior(sdk, 2,'normal',5,40,20,opts);
        setup_prior(sdk, 3,'uniform',1,0,10,opts);
        setup_prior(sdk, 4,'uniform',1,0,100,opts);
    ...
    case 'positivecosine'
        ...
        TCModelUtils.setupParameterWithUniformPrior(sdk,3,0,-2*pi,2*pi);
    ...
    case 'loggaussian'
        ...
        TCModelUtils.setupParameterWithUniformPrior(sdk,2,spread,0,2*spread);
        setup_prior(sdk, 3,'uniform',1,0,10,opts);
        setup_prior(sdk, 4,'uniform',1,0.001,10,opts);
        setup_prior(sdk, 5,'uniform',1,min(x),max(x),opts);
        collect_p5 = 1;
    otherwise
